...
var vegetables = ['brocolli', 'carrots', 'peas', 'cauliflower', 'asparagus'];

// Write the code to access the 3rd element of the Array, using bracket
// notation.

console.log(vegetables[2]); //I dont need console.log but put it in there so I can double check my method works.


// Create a new variable "fruits" and assign it to an Array of 7
// different fruits.

var fruits = ['peach', 'strawberry', 'mango', 'pineapple', 'banana', 'pear', 'apple'];
...
groceryStore.numberOfSelfCheckouts = 12;
